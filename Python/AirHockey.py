...
LEFT = False
RIGHT = True
paddle1_pos = [[0,150],[0,PAD_HEIGHT+150]]
paddle2_pos = [[WIDTH,150],[WIDTH,PAD_HEIGHT+150]]
paddle1_cntr = [(paddle1_pos[1][0]-paddle1_pos[0][0])/2 ,(paddle1_pos[1][1]-paddle1_pos[0][1])/2]
paddle1_vel = [0,0]
paddle2_vel = [0,0]
score1 = 0
score2 = 0
...
def draw(canvas):
    ...
    if ball_pos[0] <= BALL_RADIUS+PAD_WIDTH:
        if paddle1_pos[0][1] <= ball_pos[1] and ball_pos[1] <= paddle1_pos[1][1]:
            ball_vel[0] = - ball_vel[0] * 1.1       
        else:
            score2 += 1
            spawn_ball(RIGHT)
    if ball_pos[0] >= (WIDTH-1)-BALL_RADIUS - PAD_WIDTH:
        if paddle2_pos[0][1] <= ball_pos[1] and ball_pos[1] <= paddle2_pos[1][1]:
            ball_vel[0] = - ball_vel[0] * 1.1
        else:
            score1 += 1
            spawn_ball(LEFT)
